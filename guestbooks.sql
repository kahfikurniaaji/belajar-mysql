...
SELECT email FROM customers UNION SELECT email FROM guestbooks;
...
FROM customers
    INNER JOIN guestbooks ON (
        guestbooks.email = customers.email
    );
...
SELECT
    ...
    guestbooks.email
FROM customers
    LEFT JOIN guestbooks ON (
        customers.email = guestbooks.email
    )
